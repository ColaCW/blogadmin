  ...
  <div class="container">
    ...
    <div class="table">
      ...
      <baseTable ref="table" style="width: 100%" @chaneg-size="changeSizeHandle" @chaneg-page="changePageHandle" @cell-dblclick="copyCellData">
        ...
        <el-table-column prop="id" label="ID" min-width="150" align="center" :show-overflow-tooltip="true"></el-table-column>
        <el-table-column prop="uploadPath" label="文件地址" min-width="150" align="center" :show-overflow-tooltip="true"></el-table-column>
        <el-table-column prop="fileName" label="文件名" min-width="150" align="center" :show-overflow-tooltip="true"></el-table-column>
        <el-table-column prop="fileNameOld" label="原文件名" min-width="150" align="center" :show-overflow-tooltip="true"></el-table-column>
        <el-table-column prop="fileType" label="文件类型" min-width="150" align="center" :show-overflow-tooltip="true"></el-table-column>
    ...
    <el-dialog :title="'新增'+homeName" :visible.sync="addDialogStatus" width="700px">
      <el-form :model="addform" ref="addform" :inline="true" label-width="80px">
        ...
        <el-form-item prop="uploadPath" label="文件地址" >
          <el-input v-model="addform.uploadPath" style="width: 220px!important"></el-input>
        </el-form-item>
        <el-form-item prop="fileName" label="文件名" >
          <el-input v-model="addform.fileName" style="width: 220px!important"></el-input>
        </el-form-item>
        <el-form-item prop="fileNameOld" label="原文件名" >
          <el-input v-model="addform.fileNameOld" style="width: 220px!important"></el-input>
        </el-form-item>
        <el-form-item prop="fileType" label="文件类型" >
          <el-input v-model="addform.fileType" style="width: 220px!important"></el-input>
        </el-form-item>
    ...
    <el-dialog :title="'编辑'+homeName" :visible.sync="editDialogStatus" width="700px">
      <el-form :model="editform" ref="editform" :inline="true" label-width="80px">
        ...
        <el-form-item prop="uploadPath" label="文件地址" >
          <el-input v-model="editform.uploadPath" style="width: 220px!important"></el-input>
        </el-form-item>
        <el-form-item prop="fileName" label="文件名" >
          <el-input v-model="editform.fileName" style="width: 220px!important"></el-input>
        </el-form-item>
        <el-form-item prop="fileNameOld" label="原文件名" >
          <el-input v-model="editform.fileNameOld" style="width: 220px!important"></el-input>
        </el-form-item>
        <el-form-item prop="fileType" label="文件类型" >
          <el-input v-model="editform.fileType" style="width: 220px!important"></el-input>
        </el-form-item>
        <el-form-item prop="remark" label="备注" >
    ...
    <!--搜索区-->
    <el-dialog :title="'搜索'+homeName" :visible.sync="searchDialogStatus" width="530px">
      <el-form :inline="true" :model="searchform" ref="searchform">
        <el-form-item label="ID">
          <el-input v-model="searchform.id"></el-input>
        </el-form-item>
        <el-form-item label="文件地址">
          <el-input v-model="searchform.uploadPath"></el-input>
        </el-form-item>
      </el-form>
      <div slot="footer" class="dialog-footer" align="center">
